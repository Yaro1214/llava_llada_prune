    ...
    def forward(
        ...
        **kwargs,    
        ...
        if self.prune_config.is_prune:
            ...
            image_token_length=seq_length - self.prune_config.text_length - gen_length - suffix_length
...
class Pruner(LLaDAModel):
    ...
    def forward(self, *args, **kwargs):
        if self.prune_config.is_prune:
            if self.prune_config.strategy == "random_v1":
                return self.forward_random_v1(*args, **kwargs)
        else:
            return self.forward_no_prune(*args, **kwargs)
        
    def forward_no_prune(self, *args, **kwargs):
        return super().forward(*args, **kwargs)

    def forward_random_v1(
        self,
        input_ids: torch.LongTensor = None,
        attention_mask: Optional[torch.Tensor] = None,
        position_ids: Optional[torch.LongTensor] = None,
